...
export const CSS_CLASSES = {
  ...
  API_KEYS: 'streetview-api-keys',
  API_KEY_FIELD: 'streetview-api-key-field',
  API_KEY_LABEL: 'streetview-api-key-label',
  API_KEY_INPUT: 'streetview-api-key-input',
  API_KEY_APPLY: 'streetview-api-key-apply',
